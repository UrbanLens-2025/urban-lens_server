...
export const IWalletExternalTransactionQueryService = Symbol('IWalletExternalTransactionQueryService');

export interface IWalletExternalTransactionQueryService {
  getExternalTransactionById(dto: GetExternalTransactionByIdDto): Promise<WalletExternalTransactionResponseDto | null>;
  getExternalTransactionByProviderId(dto: GetExternalTransactionByProviderIdDto): Promise<WalletExternalTransactionResponseDto | null>;
  getExternalTransactionByReferenceCode(dto: GetExternalTransactionByReferenceCodeDto): Promise<WalletExternalTransactionResponseDto | null>;
  getExternalTransactionsByWalletId(dto: GetExternalTransactionsByWalletIdDto): Promise<Paginated<WalletExternalTransactionResponseDto>>;
}
...
export namespace IWalletExternalTransactionQueryService_QueryConfig {
  export function getExternalTransactionsByWalletId(): PaginateConfig<WalletExternalTransactionEntity> {
    return {
      sortableColumns: ['createdAt', 'amount', 'approvedAt', 'completedAt', 'rejectedAt'],
