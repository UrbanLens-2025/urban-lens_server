...
export const IWalletExternalTransactionManagementService = Symbol('IWalletExternalTransactionManagementService');
...
export interface IWalletExternalTransactionManagementService {
  ...
  createDepositTransaction(dto: CreateDepositTransactionDto): Promise<WalletExternalTransactionResponseDto>;

  // Withdraw transactions - require admin verification
  createWithdrawTransaction(dto: CreateWithdrawTransactionDto): Promise<WalletExternalTransactionResponseDto>;
  approveWithdrawTransaction(dto: ApproveWithdrawTransactionDto): Promise<WalletExternalTransactionResponseDto>;
  rejectWithdrawTransaction(dto: RejectWithdrawTransactionDto): Promise<WalletExternalTransactionResponseDto>;
  completeWithdrawTransaction(dto: CompleteWithdrawTransactionDto): Promise<WalletExternalTransactionResponseDto>;
}
